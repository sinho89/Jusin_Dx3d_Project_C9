...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CMapToolView), CSize(WINSIZEX, WINSIZEY), pContext);	
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CButtonMenu), CSize(300, 700), pContext);
		//WINCX, WINCY
	...
	m_pButtonMenu   = (CButtonMenu*)m_MainSplitter.GetPane(0, 0);
