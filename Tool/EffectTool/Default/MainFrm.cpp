...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CMyForm), CSize(300, WINSIZEY), pContext);
	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CEffectToolView), CSize(WINSIZEX, WINSIZEY), pContext);
