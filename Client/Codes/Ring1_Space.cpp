...
CRing1_Space::CRing1_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CRing1_Space::~CRing1_Space(void)
{

}

HRESULT CRing1_Space::Ready_Object(void)
{
...
HRESULT CRing1_Space::Start_ForScene(void)
{
...
void CRing1_Space::Update_Object(const _float& fTimeDelta)
{
...
void CRing1_Space::Render_Object(void)
{
...
HRESULT CRing1_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Ring1_Space");
...
CRing1_Space* CRing1_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CRing1_Space*		pInstance = new CRing1_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CRing1_Space* CRing1_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CRing1_Space*		pInstance = new CRing1_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CRing1_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CRing1_Space::Free(void)
{
