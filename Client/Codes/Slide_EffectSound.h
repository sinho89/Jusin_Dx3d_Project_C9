/*!
 * \file Slide_EffectSound.h
 * \date 2016/12/15 16:59
 *
 * \author ShinHo
...
#ifndef Slide_EffectSound_h__
#define Slide_EffectSound_h__
...
class CSlide_EffectSound : public CUI
{
private:
	explicit CSlide_EffectSound(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CSlide_EffectSound(void);
...
public:
	static CSlide_EffectSound* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CSlide_EffectSound* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
