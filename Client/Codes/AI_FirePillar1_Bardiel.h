#ifndef AI_FirePillar1_Bardiel_h__
#define AI_FirePillar1_Bardiel_h__
...
class CAI_FirePillar1_Bardiel
	: public CAI_Bardiel
{
private:
	explicit CAI_FirePillar1_Bardiel(void);
	virtual ~CAI_FirePillar1_Bardiel(void);
...
public:
	static CAI_FirePillar1_Bardiel* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
