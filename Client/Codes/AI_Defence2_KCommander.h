#ifndef AI_Defence2_KCommander_h__
#define AI_Defence2_KCommander_h__
...
class CAI_Defence2_KCommander
	: public CAI_Knole_Commander
{
private:
	explicit CAI_Defence2_KCommander(void);
	virtual ~CAI_Defence2_KCommander(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Defence2_KCommander* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, _bool* pWeapon,
		Engine::CAI* pAI);
