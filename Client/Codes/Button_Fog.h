...
#ifndef Button_Fog_h__
#define Button_Fog_h__
...
class CButton_Fog : public CUI
{
private:
	explicit CButton_Fog(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CButton_Fog(void);
...
public:
	static CButton_Fog* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CButton_Fog* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
