#ifndef SprialDance_Out_Trail_h__
#define SprialDance_Out_Trail_h__
...
{
private:
	explicit CSprialDance_Out_Trail(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName);
	virtual ~CSprialDance_Out_Trail(void);
...
public:
	static CSprialDance_Out_Trail* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring & wstrName);
