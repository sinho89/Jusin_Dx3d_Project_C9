#ifndef PlayerDamNum_h__
#define PlayerDamNum_h__
...
class CPlayerDamNum : public CUI
{
private:
	explicit CPlayerDamNum(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CPlayerDamNum(void);
...
public:
	static CPlayerDamNum* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CPlayerDamNum* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
