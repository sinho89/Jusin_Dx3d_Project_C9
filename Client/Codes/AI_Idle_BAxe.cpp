...
CAI_Idle_BAxe::CAI_Idle_BAxe(void)
	:CAI_Babegazi_Axe()
	, m_bOne(false)
	, m_bIdleTime(false)
	, m_fIdleTime(0.f)
...
HRESULT CAI_Idle_BAxe::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Idle_BAxe::Start_State(void)
{
...
void CAI_Idle_BAxe::Update_State(const _float & fTimeDelta)
{
...
void CAI_Idle_BAxe::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Idle_BAxe::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Idle_BAxe * CAI_Idle_BAxe::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI)
{
	CAI_Idle_BAxe* pInstance = new CAI_Idle_BAxe;
