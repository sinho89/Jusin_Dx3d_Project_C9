...
CSlide_Bright::CSlide_Bright(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CSlide_Bright::~CSlide_Bright(void)
{

}

HRESULT CSlide_Bright::Ready_Object(void)
{
...
HRESULT CSlide_Bright::Start_ForScene(void)
{
...
void CSlide_Bright::Update_Object(const _float& fTimeDelta)
{
	...
	if (m_bRender)
	{
		...
		{
			m_fX = m_pParent->GetInfo().x + 180.f - m_fBrightData;
			m_fY = m_pParent->GetInfo().y + 110.f;
		}
	...
	float fBrightness = -m_fBrightData / 255.0f;
	Engine::SetBrightness(fBrightness);
	g_ShaderOption_Info.fBrightness = m_fBrightData;
}

void CSlide_Bright::Render_Object(void)
{
...
HRESULT CSlide_Bright::Add_Component(void)
{
...
void CSlide_Bright::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
	...
	{
		m_bDragOff = false;
		m_fBrightData = m_fOriX - m_fX;
	}

}

void CSlide_Bright::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

void CSlide_Bright::Drag(void)
{
...
CSlide_Bright* CSlide_Bright::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CSlide_Bright*		pInstance = new CSlide_Bright(pGraphicDev, wstrName, eState, bIsActive);
...
CSlide_Bright* CSlide_Bright::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CSlide_Bright*		pInstance = new CSlide_Bright(pGraphicDev, wstrName, eState, bIsActive);
