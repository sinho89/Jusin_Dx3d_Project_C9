#ifndef Monster_Name_h__
#define Monster_Name_h__
...
class CMonster_Name : public CUI
{
private:
	explicit CMonster_Name(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CMonster_Name(void);
...
public:
	static CMonster_Name* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CMonster_Name* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
