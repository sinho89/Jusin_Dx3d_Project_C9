#ifndef AI_Death_BWarrior_h__
#define AI_Death_BWarrior_h__
...
class CAI_Death_BWarrior
	: public CAI_Babegazi_Warrior
{
private:
	explicit CAI_Death_BWarrior(void);
	virtual ~CAI_Death_BWarrior(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Death_BWarrior* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
