...
CAI_Death_KCommander::CAI_Death_KCommander(void)
	:CAI_Knole_Commander()
	, m_fDownTime(0.f)
	, m_bStand(false)
	, m_iDirection(0)
...
HRESULT CAI_Death_KCommander::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Death_KCommander::Start_State(void)
{
...
void CAI_Death_KCommander::Update_State(const _float & fTimeDelta)
{
...
void CAI_Death_KCommander::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Death_KCommander::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Death_KCommander * CAI_Death_KCommander::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged, _bool* pWeapon
	, Engine::CAI* pAI)
{
	CAI_Death_KCommander* pInstance = new CAI_Death_KCommander;
	...
	{
		MSG_BOX("CAI_Death_KCommander Created Failed");
...
void CAI_Death_KCommander::Free(void)
{
