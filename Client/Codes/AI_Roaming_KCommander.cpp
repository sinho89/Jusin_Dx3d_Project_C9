...
CAI_Roaming_KCommander::CAI_Roaming_KCommander(void)
	:CAI_Knole_Commander()
	,m_fRoamingTime(0.f)
	,m_fAggroRad(0.f)
	,m_bRoam(false)
...
void CAI_Roaming_KCommander::Start_State(void)
{
...
void CAI_Roaming_KCommander::Update_State(const _float & fTimeDelta)
{
	...
	{
		if (m_pAnimator->Set_AnimationSet(DISCOVERY))
		{
...
void CAI_Roaming_KCommander::End_State(void)
{

}

HRESULT CAI_Roaming_KCommander::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator
...
CAI_Roaming_KCommander * CAI_Roaming_KCommander::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CAI* pAI)
{
	CAI_Roaming_KCommander* pInstance = new CAI_Roaming_KCommander;

	if (FAILED(pInstance->Ready_State(pTransform, pAnimator, pNaviMesh, pAI)))
	{
		MSG_BOX("CAI_Roaming_KCommander Created Failed");
...
void CAI_Roaming_KCommander::Free(void)
{
