...
class CUI_Plora : public CUI_Skill
{
protected:
	explicit CUI_Plora(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CUI_Plora(void);
...
public:
	static CUI_Plora* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CUI_Plora* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
