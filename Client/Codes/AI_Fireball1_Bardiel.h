#ifndef AI_FireBall1_Bardiel_h__
#define AI_FireBall1_Bardiel_h__
...
class CAI_FireBall1_Bardiel
	: public CAI_Bardiel
{
private:
	explicit CAI_FireBall1_Bardiel(void);
	virtual ~CAI_FireBall1_Bardiel(void);
...
public:
	static CAI_FireBall1_Bardiel* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
