...
CSlide_EffectSound::CSlide_EffectSound(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CSlide_EffectSound::~CSlide_EffectSound(void)
{

}

HRESULT CSlide_EffectSound::Ready_Object(void)
{
...
HRESULT CSlide_EffectSound::Start_ForScene(void)
{
...
void CSlide_EffectSound::Update_Object(const _float& fTimeDelta)
{
	m_bRender = m_pParent->GetRender();
	g_fEffectSoundValue = ((-m_fBackSoundData / 60.f) + 1.f) * 0.5f;
	...
	if (m_bRender)
	{
		...
		else
		{
			...
			m_fY = m_pParent->GetInfo().y + 197.5f;
		}
...
void CSlide_EffectSound::Render_Object(void)
{
...
HRESULT CSlide_EffectSound::Add_Component(void)
{
...
void CSlide_EffectSound::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CSlide_EffectSound::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

void CSlide_EffectSound::Drag(void)
{
...
CSlide_EffectSound* CSlide_EffectSound::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CSlide_EffectSound*		pInstance = new CSlide_EffectSound(pGraphicDev, wstrName, eState, bIsActive);
...
CSlide_EffectSound* CSlide_EffectSound::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CSlide_EffectSound*		pInstance = new CSlide_EffectSound(pGraphicDev, wstrName, eState, bIsActive);
...
void CSlide_EffectSound::Free(void)
{
	CUI::Free();
}
