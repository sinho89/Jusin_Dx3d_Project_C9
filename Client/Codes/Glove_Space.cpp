...
CGlove_Space::CGlove_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CGlove_Space::~CGlove_Space(void)
{

}

HRESULT CGlove_Space::Ready_Object(void)
{
...
HRESULT CGlove_Space::Start_ForScene(void)
{
	...
	if (m_pPlayer->GetPlayerInfo()->m_eClassID == CLASS_WITHBLADE)
		...
		m_eType = ITEM_S_GLOVE;

	return S_OK;
}

void CGlove_Space::Update_Object(const _float& fTimeDelta)
{
...
void CGlove_Space::Render_Object(void)
{
...
HRESULT CGlove_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Glove_Space");
...
CGlove_Space* CGlove_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CGlove_Space*		pInstance = new CGlove_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CGlove_Space* CGlove_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CGlove_Space*		pInstance = new CGlove_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CGlove_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CGlove_Space::Free(void)
{
