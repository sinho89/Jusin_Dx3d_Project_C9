...
CAmulet_Space::CAmulet_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CAmulet_Space::~CAmulet_Space(void)
{

}

HRESULT CAmulet_Space::Ready_Object(void)
{
...
HRESULT CAmulet_Space::Start_ForScene(void)
{
...
void CAmulet_Space::Update_Object(const _float& fTimeDelta)
{
...
void CAmulet_Space::Render_Object(void)
{
...
HRESULT CAmulet_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Amulet_Space");
...
CAmulet_Space* CAmulet_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CAmulet_Space*		pInstance = new CAmulet_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CAmulet_Space* CAmulet_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CAmulet_Space*		pInstance = new CAmulet_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CAmulet_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CAmulet_Space::Free(void)
{
