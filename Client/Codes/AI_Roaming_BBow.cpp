...
CAI_Roaming_BBow::CAI_Roaming_BBow(void)
	:CAI_Babegazi_Bow()
	,m_fRoamingTime(0.f)
	,m_fAggroRad(0.f)
	,m_bRoam(false)
...
void CAI_Roaming_BBow::Start_State(void)
{
...
void CAI_Roaming_BBow::Update_State(const _float & fTimeDelta)
{
...
void CAI_Roaming_BBow::End_State(void)
{

}

HRESULT CAI_Roaming_BBow::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator
...
CAI_Roaming_BBow * CAI_Roaming_BBow::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CAI* pAI)
{
	CAI_Roaming_BBow* pInstance = new CAI_Roaming_BBow;

	if (FAILED(pInstance->Ready_State(pTransform, pAnimator, pNaviMesh, pAI)))
	{
		MSG_BOX("CAI_Roaming_BBow Created Failed");
...
void CAI_Roaming_BBow::Free(void)
{
