#ifndef PenaltyTrail_h__
#define PenaltyTrail_h__
...
{
private:
	explicit CPenaltyTrail(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName);
	virtual ~CPenaltyTrail(void);
...
public:
	static CPenaltyTrail* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring & wstrName);
