#ifndef AI_Attack2_KCommander_h__
#define AI_Attack2_KCommander_h__
...
class CAI_Attack2_KCommander
	: public CAI_Knole_Commander
{
private:
	explicit CAI_Attack2_KCommander(void);
	virtual ~CAI_Attack2_KCommander(void);
...
public:
	static CAI_Attack2_KCommander* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, _bool* pWeapon,
		Engine::CAI* pAI, CSound* pSound);
