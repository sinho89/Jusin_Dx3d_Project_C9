...
CAI_Discovery_BAxe::CAI_Discovery_BAxe(void)
	:CAI_Babegazi_Axe()
	, m_fAggroRad(0.f)
	, m_bAggro(false)
{
...
HRESULT CAI_Discovery_BAxe::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Discovery_BAxe::Start_State(void)
{
	m_bAggro = false;
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Discovery_BAxe::Update_State(const _float & fTimeDelta)
{
...
void CAI_Discovery_BAxe::End_State(void)
{

}


void CAI_Discovery_BAxe::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Discovery_BAxe * CAI_Discovery_BAxe::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI, CSound* pSound)
{
	CAI_Discovery_BAxe* pInstance = new CAI_Discovery_BAxe;
	...
	{
		MSG_BOX("CAI_Discovery_BAxe Created Failed");
...
void CAI_Discovery_BAxe::Free(void)
{
