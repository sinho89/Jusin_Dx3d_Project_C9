...
void CAI_Bardiel::Start_State(void)
{
}

void CAI_Bardiel::Update_State(const _float & fTimeDelta)
{
}

void CAI_Bardiel::End_State(void)
{
}

void CAI_Bardiel::Set_Ray(void)
{
...
void CAI_Bardiel::ChangeAni_Work(void)
{
...
void CAI_Bardiel::ChangeAI_Work(void)
{
	////AI 바뀌는곳..
...
void CAI_Bardiel::Free(void)
{

}

void CAI_Bardiel::CubeRayCheck(void)
{
