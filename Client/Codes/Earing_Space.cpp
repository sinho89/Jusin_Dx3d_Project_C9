...
CEaring_Space::CEaring_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CEaring_Space::~CEaring_Space(void)
{

}

HRESULT CEaring_Space::Ready_Object(void)
{
...
HRESULT CEaring_Space::Start_ForScene(void)
{
...
void CEaring_Space::Update_Object(const _float& fTimeDelta)
{
...
void CEaring_Space::Render_Object(void)
{
...
HRESULT CEaring_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Earing_Space");
...
CEaring_Space* CEaring_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CEaring_Space*		pInstance = new CEaring_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CEaring_Space* CEaring_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CEaring_Space*		pInstance = new CEaring_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CEaring_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CEaring_Space::Free(void)
{
