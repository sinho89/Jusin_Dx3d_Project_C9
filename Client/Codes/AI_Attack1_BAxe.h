#ifndef AI_Attack1_BAxe_h__
#define AI_Attack1_BAxe_h__
...
class CAI_Attack1_BAxe
	: public CAI_Babegazi_Axe
{
private:
	explicit CAI_Attack1_BAxe(void);
	virtual ~CAI_Attack1_BAxe(void);
...
public:
	static CAI_Attack1_BAxe* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
