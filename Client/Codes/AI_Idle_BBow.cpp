...
CAI_Idle_BBow::CAI_Idle_BBow(void)
	:CAI_Babegazi_Bow()
	, m_bOne(false)
	, m_bIdleTime(false)
	, m_fIdleTime(0.f)
...
HRESULT CAI_Idle_BBow::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Idle_BBow::Start_State(void)
{
...
void CAI_Idle_BBow::Update_State(const _float & fTimeDelta)
{
...
void CAI_Idle_BBow::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Idle_BBow::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Idle_BBow * CAI_Idle_BBow::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI)
{
	CAI_Idle_BBow* pInstance = new CAI_Idle_BBow;
