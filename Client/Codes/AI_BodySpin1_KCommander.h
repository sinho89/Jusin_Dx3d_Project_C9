#ifndef AI_BodySpin1_KCommander_h__
#define AI_BodySpin1_KCommander_h__
...
class CAI_BodySpin1_KCommander
	: public CAI_Knole_Commander
{
private:
	explicit CAI_BodySpin1_KCommander(void);
	virtual ~CAI_BodySpin1_KCommander(void);
...
public:
	static CAI_BodySpin1_KCommander* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, _bool* pWeapon,
		Engine::CAI* pAI, CSound* pSound);
