...
CWear_ToolTip::CWear_ToolTip(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CWear_ToolTip::~CWear_ToolTip(void)
{

}

HRESULT CWear_ToolTip::Ready_Object(void)
{
...
HRESULT CWear_ToolTip::Start_ForScene(void)
{
...
void CWear_ToolTip::Update_Object(const _float& fTimeDelta)
{
	if(m_bRender)
	{		
...
void CWear_ToolTip::Render_Object(void)
{
...
void CWear_ToolTip::SetItem(CUI_Item* pItem)
{
	m_pItem = pItem;
}

void CWear_ToolTip::SetId(TOOLTIP_ID eID)
{
	m_eType = eID;
}

HRESULT CWear_ToolTip::Add_Component(void)
{
...
CWear_ToolTip* CWear_ToolTip::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CWear_ToolTip*		pInstance = new CWear_ToolTip(pGraphicDev, wstrName, eState, bIsActive);
