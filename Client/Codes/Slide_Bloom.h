...
#ifndef Slide_Bloom_h__
#define Slide_Bloom_h__
...
class CSlide_Bloom : public CUI
{
private:
	explicit CSlide_Bloom(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CSlide_Bloom(void);
...
public:
	static CSlide_Bloom* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CSlide_Bloom* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
