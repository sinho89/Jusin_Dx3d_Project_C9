...
CToolTip::CToolTip(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
HRESULT CToolTip::Ready_Object(void)
{
...
HRESULT CToolTip::Start_ForScene(void)
{
...
void CToolTip::Update_Object(const _float& fTimeDelta)
{
	if(m_bRender)
	{		
...
void CToolTip::Render_Object(void)
{
...
void CToolTip::SetItem(CUI_Item* pItem)
{
	m_pItem = pItem;
}

void CToolTip::SetId(TOOLTIP_ID eID)
{
	m_eType = eID;
}

HRESULT CToolTip::Add_Component(void)
{
...
CToolTip* CToolTip::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CToolTip*		pInstance = new CToolTip(pGraphicDev, wstrName, eState, bIsActive);
