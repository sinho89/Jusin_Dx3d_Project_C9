...
#ifndef Button_MB_h__
#define Button_MB_h__
...
class CButton_MB : public CUI
{
private:
	explicit CButton_MB(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CButton_MB(void);
...
public:
	static CButton_MB* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CButton_MB* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
