...
CAI_Discovery_BWarrior::CAI_Discovery_BWarrior(void)
...
HRESULT CAI_Discovery_BWarrior::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Discovery_BWarrior::Start_State(void)
{
	m_bAggro = false;
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Discovery_BWarrior::Update_State(const _float & fTimeDelta)
{
...
void CAI_Discovery_BWarrior::End_State(void)
{

}


void CAI_Discovery_BWarrior::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Discovery_BWarrior * CAI_Discovery_BWarrior::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
    , Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI, CSound* pSound)
{
	CAI_Discovery_BWarrior* pInstance = new CAI_Discovery_BWarrior;
	...
	{
		MSG_BOX("CAI_Discovery_BWarrior Created Failed");
...
void CAI_Discovery_BWarrior::Free(void)
{
