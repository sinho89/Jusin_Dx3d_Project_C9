...
CShop_ToolTip::CShop_ToolTip(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CShop_ToolTip::~CShop_ToolTip(void)
{

}

HRESULT CShop_ToolTip::Ready_Object(void)
{
...
HRESULT CShop_ToolTip::Start_ForScene(void)
{
...
void CShop_ToolTip::Update_Object(const _float& fTimeDelta)
{
	if (m_bRender)
	{
...
void CShop_ToolTip::Render_Object(void)
{
...
void CShop_ToolTip::SetItem(CUI_Item* pItem)
{
	m_pItem = pItem;
}

void CShop_ToolTip::SetId(TOOLTIP_ID eID)
{
	m_eType = eID;
}

HRESULT CShop_ToolTip::Add_Component(void)
{
...
CShop_ToolTip* CShop_ToolTip::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CShop_ToolTip*		pInstance = new CShop_ToolTip(pGraphicDev, wstrName, eState, bIsActive);
