...
CMiniMap_ZoomOut::CMiniMap_ZoomOut(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CMiniMap_ZoomOut::~CMiniMap_ZoomOut(void)
{

}

HRESULT CMiniMap_ZoomOut::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 630.f;
	m_fY = (WINSIZEY >> 1) - 270.f;
...
HRESULT CMiniMap_ZoomOut::Start_ForScene(void)
{
...
void CMiniMap_ZoomOut::Update_Object(const _float& fTimeDelta)
{
...
void CMiniMap_ZoomOut::Render_Object(void)
{
...
HRESULT CMiniMap_ZoomOut::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomOut_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomOut_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomOut_Click");
...
void CMiniMap_ZoomOut::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
CMiniMap_ZoomOut* CMiniMap_ZoomOut::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CMiniMap_ZoomOut*		pInstance = new CMiniMap_ZoomOut(pGraphicDev, wstrName, eState, bIsActive);
...
void CMiniMap_ZoomOut::Free(void)
{
	CUI::Free();
}
