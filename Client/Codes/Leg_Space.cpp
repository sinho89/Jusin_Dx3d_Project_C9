...
CLeg_Space::CLeg_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CLeg_Space::~CLeg_Space(void)
{

}

HRESULT CLeg_Space::Ready_Object(void)
{
...
HRESULT CLeg_Space::Start_ForScene(void)
{
...
void CLeg_Space::Update_Object(const _float& fTimeDelta)
{
...
void CLeg_Space::Render_Object(void)
{
...
HRESULT CLeg_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Leg_Space");
...
CLeg_Space* CLeg_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CLeg_Space*		pInstance = new CLeg_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CLeg_Space* CLeg_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CLeg_Space*		pInstance = new CLeg_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CLeg_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CLeg_Space::Free(void)
{
