...
CArmor_Space::CArmor_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CArmor_Space::~CArmor_Space(void)
{

}

HRESULT CArmor_Space::Ready_Object(void)
{
...
HRESULT CArmor_Space::Start_ForScene(void)
{
	...
	if (m_pPlayer->GetPlayerInfo()->m_eClassID == CLASS_WITHBLADE)
		...
		m_eType = ITEM_S_ARMOR;

	return S_OK;
}

void CArmor_Space::Update_Object(const _float& fTimeDelta)
{
...
void CArmor_Space::Render_Object(void)
{
...
HRESULT CArmor_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Armor_Space");
...
CArmor_Space* CArmor_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CArmor_Space*		pInstance = new CArmor_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CArmor_Space* CArmor_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CArmor_Space*		pInstance = new CArmor_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CArmor_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CArmor_Space::Free(void)
{
