...
CButton_LevelUp::CButton_LevelUp(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_LevelUp::~CButton_LevelUp(void)
{

}

HRESULT CButton_LevelUp::Ready_Object(void)
{
	if (FAILED(Add_Component()))
		return E_FAIL;

	m_fX = m_pParent->GetInfo().x - 210.f;
...
HRESULT CButton_LevelUp::Start_ForScene(void)
{
...
void CButton_LevelUp::Update_Object(const _float& fTimeDelta)
{
...
void CButton_LevelUp::Render_Object(void)
{
	...
	Engine::Render_Font(L"Font_Main_Button", L"·¹º§ ¾÷", &_vec2(m_fX - 20.f, m_fY - 10.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));

}


HRESULT CButton_LevelUp::Add_Component(void)
{
...
void CButton_LevelUp::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CButton_LevelUp::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_LevelUp* CButton_LevelUp::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_LevelUp*		pInstance = new CButton_LevelUp(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_LevelUp* CButton_LevelUp::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_LevelUp*		pInstance = new CButton_LevelUp(pGraphicDev, wstrName, eState, bIsActive);
...
void CButton_LevelUp::Free(void)
{
	CUI::Free();
}
