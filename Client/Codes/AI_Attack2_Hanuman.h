#ifndef AI_Attack2_Hanuman_h__
#define AI_Attack2_Hanuman_h__
...
class CAI_Attack2_Hanuman
	: public CAI_Hanuman
{
private:
	explicit CAI_Attack2_Hanuman(void);
	virtual ~CAI_Attack2_Hanuman(void);
...
public:
	static CAI_Attack2_Hanuman* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
