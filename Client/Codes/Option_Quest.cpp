...
COption_Quest::COption_Quest(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
COption_Quest::~COption_Quest(void)
{

}

HRESULT COption_Quest::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) - 90.f;
	m_fY = (WINSIZEY >> 1);
...
HRESULT COption_Quest::Start_ForScene(void)
{
...
void COption_Quest::Update_Object(const _float& fTimeDelta)
{
...
void COption_Quest::Render_Object(void)
{
	...
	if(m_bClick || m_bCollision)
	{
		Engine::Render_Font(L"Font_Main_Data", L"(L) Äù½ºÆ® ", &_vec2(m_fX - 30.f, m_fY - 45.f), D3DXCOLOR(1.f, 1.f, 1.f, m_fAlpha));
	}
}


HRESULT COption_Quest::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Quest");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Quest_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Quest_Click");
...
void COption_Quest::Alpha_Calculation(const _float& fTimeDelta)
{
	if(!m_bRender)
	{
...
void COption_Quest::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
COption_Quest* COption_Quest::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	COption_Quest*		pInstance = new COption_Quest(pGraphicDev, wstrName, eState, bIsActive);
