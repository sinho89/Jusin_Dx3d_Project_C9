#ifndef AI_Defence_BAxe_h__
#define AI_Defence_BAxe_h__
...
class CAI_Defence_BAxe
	: public CAI_Babegazi_Axe
{
private:
	explicit CAI_Defence_BAxe(void);
	virtual ~CAI_Defence_BAxe(void);
...
public:
	static CAI_Defence_BAxe* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
