...
class CUI_UpAtt : public CUI_Skill
{
protected:
	explicit CUI_UpAtt(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CUI_UpAtt(void);
...
public:
	static CUI_UpAtt* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CUI_UpAtt* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
