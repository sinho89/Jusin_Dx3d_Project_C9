...
class CBossTex : public CUI
{
private:
	explicit CBossTex(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CBossTex(void);
...
public:
	static CBossTex* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CBossTex* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
