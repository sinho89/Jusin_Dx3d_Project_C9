...
CPage_Next_Button::CPage_Next_Button(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CPage_Next_Button::~CPage_Next_Button(void)
{

}

HRESULT CPage_Next_Button::Ready_Object(void)
{
...
HRESULT CPage_Next_Button::Start_ForScene(void)
{
...
void CPage_Next_Button::Update_Object(const _float& fTimeDelta)
{
...
void CPage_Next_Button::Render_Object(void)
{
...
HRESULT CPage_Next_Button::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Skill_Page_Next_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Skill_Page_Next_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Skill_Page_Next_Click");
...
void CPage_Next_Button::PtInRect_Collision(const _float& fTimeDelta)
{
	_vec4 vInfo = m_pParentWindow->GetInfo();
	...
	if(m_bButtonCollision)
	{
		if(Engine::Get_DIMouseState(Engine::CInput_Device::DIM_LB) & 0x80)
		{
			...
			if(pUI->GetSlotLevel() >= 2 || ((CSkill_Sheet*)pUI)->GetType() == true)
			{
				::Safe_Release(pUI);
				return;
			}
...
void CPage_Next_Button::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}

CPage_Next_Button* CPage_Next_Button::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CPage_Next_Button*		pInstance = new CPage_Next_Button(pGraphicDev, wstrName, eState, bIsActive);
...
CPage_Next_Button* CPage_Next_Button::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CPage_Next_Button*		pInstance = new CPage_Next_Button(pGraphicDev, wstrName, eState, bIsActive);
...
void CPage_Next_Button::Free(void)
{
