...
CInven_Array::CInven_Array(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CInven_Array::~CInven_Array(void)
{

}

HRESULT CInven_Array::Ready_Object(void)
{
...
HRESULT CInven_Array::Start_ForScene(void)
{
...
void CInven_Array::Update_Object(const _float& fTimeDelta)
{
...
void CInven_Array::Render_Object(void)
{
...
HRESULT CInven_Array::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Inven_Array_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Inven_Array_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Inven_Array_Click");
...
void CInven_Array::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CInven_Array::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CInven_Array* CInven_Array::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CInven_Array*		pInstance = new CInven_Array(pGraphicDev, wstrName, eState, bIsActive);
...
CInven_Array* CInven_Array::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CInven_Array*		pInstance = new CInven_Array(pGraphicDev, wstrName, eState, bIsActive);
