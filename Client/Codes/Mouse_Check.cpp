...
CMouse_Check::CMouse_Check(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CMouse_Check::~CMouse_Check(void)
{

}

HRESULT CMouse_Check::Ready_Object(void)
{
...
HRESULT CMouse_Check::Start_ForScene(void)
{
...
void CMouse_Check::Update_Object(const _float& fTimeDelta)
{
...
void CMouse_Check::Render_Object(void)
{
...
HRESULT CMouse_Check::Add_Component(void)
{
...
void CMouse_Check::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CMouse_Check::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CMouse_Check* CMouse_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CMouse_Check*		pInstance = new CMouse_Check(pGraphicDev, wstrName, eState, bIsActive);
...
CMouse_Check* CMouse_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CMouse_Check*		pInstance = new CMouse_Check(pGraphicDev, wstrName, eState, bIsActive);
