...
CShorder_Space::CShorder_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CShorder_Space::~CShorder_Space(void)
{

}

HRESULT CShorder_Space::Ready_Object(void)
{
...
HRESULT CShorder_Space::Start_ForScene(void)
{
	...
	if (m_pPlayer->GetPlayerInfo()->m_eClassID == CLASS_WITHBLADE)
		m_eType = ITEM_SHORDER;
	else
		m_eType = ITEM_S_SHORDER;

	return S_OK;
}

void CShorder_Space::Update_Object(const _float& fTimeDelta)
{
...
void CShorder_Space::Render_Object(void)
{
...
HRESULT CShorder_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Shorder_Space");
...
CShorder_Space* CShorder_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CShorder_Space*		pInstance = new CShorder_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CShorder_Space* CShorder_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CShorder_Space*		pInstance = new CShorder_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CShorder_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CShorder_Space::Free(void)
{
