...
CBelt_Space::CBelt_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CBelt_Space::~CBelt_Space(void)
{

}

HRESULT CBelt_Space::Ready_Object(void)
{
...
HRESULT CBelt_Space::Start_ForScene(void)
{
...
void CBelt_Space::Update_Object(const _float& fTimeDelta)
{
...
void CBelt_Space::Render_Object(void)
{
...
HRESULT CBelt_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Belt_Space");
...
CBelt_Space* CBelt_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CBelt_Space*		pInstance = new CBelt_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CBelt_Space* CBelt_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CBelt_Space*		pInstance = new CBelt_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CBelt_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CBelt_Space::Free(void)
{
