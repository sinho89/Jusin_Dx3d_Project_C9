...
COption_Guild::COption_Guild(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
COption_Guild::~COption_Guild(void)
{

}

HRESULT COption_Guild::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) - 45.f;
	m_fY = (WINSIZEY >> 1);
...
HRESULT COption_Guild::Start_ForScene(void)
{
...
void COption_Guild::Update_Object(const _float& fTimeDelta)
{
...
void COption_Guild::Render_Object(void)
{
	...
	if(m_bClick || m_bCollision)
	{
		Engine::Render_Font(L"Font_Main_Data", L"(U) ±æµå ", &_vec2(m_fX - 30.f, m_fY - 45.f), D3DXCOLOR(1.f, 1.f, 1.f, m_fAlpha));
	}
}


HRESULT COption_Guild::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Guild");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Guild_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_Guild_Click");
...
void COption_Guild::Alpha_Calculation(const _float& fTimeDelta)
{
	if(!m_bRender)
	{
...
void COption_Guild::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
COption_Guild* COption_Guild::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	COption_Guild*		pInstance = new COption_Guild(pGraphicDev, wstrName, eState, bIsActive);
