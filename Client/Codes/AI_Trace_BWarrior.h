#ifndef AI_Trace_BWarrior_h__
#define AI_Trace_BWarrior_h__
...
class CAI_Trace_BWarrior
	: public CAI_Babegazi_Warrior
{
private:
	explicit CAI_Trace_BWarrior(void);
	virtual ~CAI_Trace_BWarrior(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Trace_BWarrior* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, 
		Engine::CAI* pAI);
