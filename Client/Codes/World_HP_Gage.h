#ifndef World_HP_Gage_h__
#define World_HP_Gage_h__
...
class CWorld_HP_Gage : public CUI
{
private:
	explicit CWorld_HP_Gage(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CWorld_HP_Gage(void);
...
public:
	static CWorld_HP_Gage* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CWorld_HP_Gage* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
