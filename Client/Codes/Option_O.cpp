...
COption_O::COption_O(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
COption_O::~COption_O(void)
{

}

HRESULT COption_O::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 185.f;
	m_fY = (WINSIZEY >> 1);
...
HRESULT COption_O::Start_ForScene(void)
{
...
void COption_O::Update_Object(const _float& fTimeDelta)
{
...
void COption_O::Render_Object(void)
{
	...
	if(m_bClick || m_bCollision)
	{
		Engine::Render_Font(L"Font_Main_Data", L"(O) Ä£±¸", &_vec2(m_fX - 30.f, m_fY - 45.f), D3DXCOLOR(1.f, 1.f, 1.f, m_fAlpha));
	}
}


HRESULT COption_O::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_O");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_O_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_O_Click");
...
void COption_O::Alpha_Calculation(const _float& fTimeDelta)
{
	if(!m_bRender)
	{
...
void COption_O::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
COption_O* COption_O::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	COption_O*		pInstance = new COption_O(pGraphicDev, wstrName, eState, bIsActive);
