...
CMiniMap_ZoomIn::CMiniMap_ZoomIn(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CMiniMap_ZoomIn::~CMiniMap_ZoomIn(void)
{

}

HRESULT CMiniMap_ZoomIn::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 600.f;
	m_fY = (WINSIZEY >> 1) - 300.f;
...
HRESULT CMiniMap_ZoomIn::Start_ForScene(void)
{
...
void CMiniMap_ZoomIn::Update_Object(const _float& fTimeDelta)
{
...
void CMiniMap_ZoomIn::Render_Object(void)
{
...
HRESULT CMiniMap_ZoomIn::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomIn_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomIn_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"MiniMap_ZoomIn_Click");
...
void CMiniMap_ZoomIn::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
CMiniMap_ZoomIn* CMiniMap_ZoomIn::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CMiniMap_ZoomIn*		pInstance = new CMiniMap_ZoomIn(pGraphicDev, wstrName, eState, bIsActive);
...
void CMiniMap_ZoomIn::Free(void)
{
	CUI::Free();
}
