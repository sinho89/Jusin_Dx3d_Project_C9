#ifndef AI_FireRain2_Bardiel_h__
#define AI_FireRain2_Bardiel_h__
...
class CAI_FireRain2_Bardiel
	: public CAI_Bardiel
{
private:
	explicit CAI_FireRain2_Bardiel(void);
	virtual ~CAI_FireRain2_Bardiel(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_FireRain2_Bardiel* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, 
		Engine::CAI* pAI);
