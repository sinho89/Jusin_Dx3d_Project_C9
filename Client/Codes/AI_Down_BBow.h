#ifndef AI_Down_BBow_h__
#define AI_Down_BBow_h__
...
{
private:
	explicit CAI_Down_BBow(void);
	virtual ~CAI_Down_BBow(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Down_BBow* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
