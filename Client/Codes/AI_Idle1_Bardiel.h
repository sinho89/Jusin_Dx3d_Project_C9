#ifndef AI_Idle1_Bardiel_h__
#define AI_Idle1_Bardiel_h__
...
class CAI_Idle1_Bardiel
	: public CAI_Bardiel
{
private:
	explicit CAI_Idle1_Bardiel(void);
	virtual ~CAI_Idle1_Bardiel(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Idle1_Bardiel* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
