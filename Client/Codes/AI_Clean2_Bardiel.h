#ifndef AI_Clean2_Bardiel_h__
#define AI_Clean2_Bardiel_h__
...
class CAI_Clean2_Bardiel
	: public CAI_Bardiel
{
private:
	explicit CAI_Clean2_Bardiel(void);
	virtual ~CAI_Clean2_Bardiel(void);
...
public:
	static CAI_Clean2_Bardiel* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
