...
CAI_Death_BWarrior::CAI_Death_BWarrior(void)
...
HRESULT CAI_Death_BWarrior::Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
...
void CAI_Death_BWarrior::Start_State(void)
{
...
void CAI_Death_BWarrior::Update_State(const _float & fTimeDelta)
{
...
void CAI_Death_BWarrior::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Death_BWarrior::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Death_BWarrior * CAI_Death_BWarrior::Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
	Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
	Engine::COLINFO* pColInfo, _bool* pDamaged,
	Engine::CAI* pAI)
{
	CAI_Death_BWarrior* pInstance = new CAI_Death_BWarrior;

	if (FAILED(pInstance->Ready_State(pTransform, pAnimator, pNaviMesh, pCalculator, pRigidbody
	, pCollider, pColInfo, pDamaged, pAI)))
	{
		MSG_BOX("CAI_Death_BWarrior Created Failed");
...
void CAI_Death_BWarrior::Free(void)
{
