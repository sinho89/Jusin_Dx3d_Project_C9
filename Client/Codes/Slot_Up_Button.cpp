...
CSlot_Up_Button::CSlot_Up_Button(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CSlot_Up_Button::~CSlot_Up_Button(void)
{

}

HRESULT CSlot_Up_Button::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 270.f;
	m_fY = (WINSIZEY >> 1) + 386.f;
...
HRESULT CSlot_Up_Button::Start_ForScene(void)
{
...
void CSlot_Up_Button::Update_Object(const _float& fTimeDelta)
{
...
void CSlot_Up_Button::Render_Object(void)
{
...
HRESULT CSlot_Up_Button::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_Slot_Up_Button_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_Slot_Up_Button_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_Slot_Up_Button_Click");
...
void CSlot_Up_Button::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
CSlot_Up_Button* CSlot_Up_Button::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CSlot_Up_Button*		pInstance = new CSlot_Up_Button(pGraphicDev, wstrName, eState, bIsActive);
...
void CSlot_Up_Button::Free(void)
{
	CUI::Free();
}
