...
CBoots_Space::CBoots_Space(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CBoots_Space::~CBoots_Space(void)
{

}

HRESULT CBoots_Space::Ready_Object(void)
{
...
HRESULT CBoots_Space::Start_ForScene(void)
{
	...
	if (m_pPlayer->GetPlayerInfo()->m_eClassID == CLASS_WITHBLADE)
		...
		m_eType = ITEM_S_BOOTS;

	return S_OK;
}

void CBoots_Space::Update_Object(const _float& fTimeDelta)
{
...
void CBoots_Space::Render_Object(void)
{
...
HRESULT CBoots_Space::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Boot_Space");
...
CBoots_Space* CBoots_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CBoots_Space*		pInstance = new CBoots_Space(pGraphicDev, wstrName, eState, bIsActive);
...
CBoots_Space* CBoots_Space::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParentWindow, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CBoots_Space*		pInstance = new CBoots_Space(pGraphicDev, wstrName, eState, bIsActive);
...
void CBoots_Space::SetParent(CUI* pParentWindow)
{
	m_pParentWindow = pParentWindow;
}


void CBoots_Space::Free(void)
{
