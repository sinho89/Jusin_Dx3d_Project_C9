...
#ifndef Debug_Check_h__
#define Debug_Check_h__
...
class CDebug_Check : public CUI
{
private:
	explicit CDebug_Check(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CDebug_Check(void);
...
public:
	static CDebug_Check* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CDebug_Check* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
