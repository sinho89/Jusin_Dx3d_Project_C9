...
CAI_FireWall2_Bardiel::CAI_FireWall2_Bardiel(void)
	:CAI_Bardiel()
	,m_bAttackCol1(false)
	,m_bAttackCol2(false)
	,m_bAttackCol3(false)
...
HRESULT CAI_FireWall2_Bardiel::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_FireWall2_Bardiel::Start_State(void)
{
...
void CAI_FireWall2_Bardiel::Update_State(const _float & fTimeDelta)
{
	...
	if (m_pAnimator->Get_AnimationIndex() == ATT_FIRE_WALL)
	{
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.0,
			(*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.1))
		{
			m_pSound->MyPlaySound(L"Bardiel_FireWall_Voice");
		}
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.35,
			(*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.375))
		{
			...
			if (!m_bAttackCol1)
			{
				...
				m_pSphereCollider->SetPos(_vec3(13.f, 3.f, 45.f));
		...
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.40,
			(*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.425))
		{
			m_pSound->MyPlaySound(L"Bardiel_FireWall_Stone_1");
			if (!m_bAttackCol2)
			{
				Engine::Set_Shake(Engine::CAMERA_PLAYER, _vec3(0.f, 1.f, 0.f), 0.9f, 4);
				m_bAttackCol2 = true;
		...
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.425,
			(*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.45))
		{
			m_pSound->MyPlaySound(L"Bardiel_FireWall_Stone_1");
			if (!m_bAttackCol3)
			{
				...
				m_bAttackCol3 = true;
				m_pSphereCollider->SetScale(15.f);
				m_pSphereCollider->SetPos(_vec3(-10.f, 3.f, 25.f));
				Engine::COLINFO tColInfo;
				tColInfo.eColInfo = Engine::COL_PUSH;
				tColInfo.eColDir = Engine::DIR_DEST;
				tColInfo.fJumpForce = 1.2f;
		...
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.45,
			(*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_FIRE_WALL]->tMotionInfo.dEndTime * 0.5))
		{
			m_pSound->MyPlaySound(L"Bardiel_FireWall_Stone_2");
			if (!m_bAttackCol4)
			{
				Engine::Set_Shake(Engine::CAMERA_PLAYER, _vec3(0.f, 1.f, 0.f), 0.9f, 4);
				m_bAttackCol4 = true;
				m_pSphereCollider->SetScale(15.f);
				m_pSphereCollider->SetPos(_vec3(-18.f, 3.f, 5.f));
				Engine::COLINFO tColInfo;
				tColInfo.eColInfo = Engine::COL_PUSH;
				tColInfo.eColDir = Engine::DIR_DEST;
				tColInfo.fJumpForce = 1.2f;
...
void CAI_FireWall2_Bardiel::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

//void CAI_FireWall2_Bardiel::CubeRayCheck(void)
//{
...
void CAI_FireWall2_Bardiel::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_FireWall2_Bardiel * CAI_FireWall2_Bardiel::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI, CSound* pSound)
{
	CAI_FireWall2_Bardiel* pInstance = new CAI_FireWall2_Bardiel;
	...
	{
		MSG_BOX("CAI_FireWall2_Bardiel Created Failed");
...
void CAI_FireWall2_Bardiel::Free(void)
{
