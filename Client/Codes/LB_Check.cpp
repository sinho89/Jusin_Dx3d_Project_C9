...
CLB_Check::CLB_Check(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CLB_Check::~CLB_Check(void)
{

}

HRESULT CLB_Check::Ready_Object(void)
{
...
HRESULT CLB_Check::Start_ForScene(void)
{
...
void CLB_Check::Update_Object(const _float& fTimeDelta)
{
...
void CLB_Check::Render_Object(void)
{
...
HRESULT CLB_Check::Add_Component(void)
{
...
void CLB_Check::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CLB_Check::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CLB_Check* CLB_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CLB_Check*		pInstance = new CLB_Check(pGraphicDev, wstrName, eState, bIsActive);
...
CLB_Check* CLB_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CLB_Check*		pInstance = new CLB_Check(pGraphicDev, wstrName, eState, bIsActive);
