...
CWorld_HP_Bar::CWorld_HP_Bar(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CWorld_HP_Bar::~CWorld_HP_Bar(void)
{

}

HRESULT CWorld_HP_Bar::Ready_Object(void)
{
...
HRESULT CWorld_HP_Bar::Start_ForScene(void)
{
	return S_OK;
}

void CWorld_HP_Bar::Update_Object(const _float& fTimeDelta)
{
...
void CWorld_HP_Bar::Render_Object(void)
{
...
HRESULT CWorld_HP_Bar::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
	pEffect->AddRef();
...
void CWorld_HP_Bar::Alpha_Calculation(const _float& fTimeDelta)
{
...
HRESULT CWorld_HP_Bar::Add_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Monster_Bar");
...
CWorld_HP_Bar* CWorld_HP_Bar::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CWorld_HP_Bar*		pInstance = new CWorld_HP_Bar(pGraphicDev, wstrName, eState, bIsActive);
...
CWorld_HP_Bar* CWorld_HP_Bar::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, Engine::CGameObject* pParentObject, MONSTER_ID eType, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CWorld_HP_Bar*		pInstance = new CWorld_HP_Bar(pGraphicDev, wstrName, eState, bIsActive);
