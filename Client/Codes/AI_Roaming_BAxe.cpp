...
CAI_Roaming_BAxe::CAI_Roaming_BAxe(void)
	:CAI_Babegazi_Axe()
	,m_fRoamingTime(0.f)
	,m_fAggroRad(0.f)
	,m_bRoam(false)
...
void CAI_Roaming_BAxe::Start_State(void)
{
...
void CAI_Roaming_BAxe::Update_State(const _float & fTimeDelta)
{
...
void CAI_Roaming_BAxe::End_State(void)
{

}

HRESULT CAI_Roaming_BAxe::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator
...
CAI_Roaming_BAxe * CAI_Roaming_BAxe::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CAI* pAI)
{
	CAI_Roaming_BAxe* pInstance = new CAI_Roaming_BAxe;

	if (FAILED(pInstance->Ready_State(pTransform, pAnimator, pNaviMesh, pAI)))
	{
		MSG_BOX("CAI_Roaming_BAxe Created Failed");
...
void CAI_Roaming_BAxe::Free(void)
{
