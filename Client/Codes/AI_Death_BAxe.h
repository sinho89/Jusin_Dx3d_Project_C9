#ifndef AI_Death_BAxe_h__
#define AI_Death_BAxe_h__
...
class CAI_Death_BAxe
	: public CAI_Babegazi_Axe
{
private:
	explicit CAI_Death_BAxe(void);
	virtual ~CAI_Death_BAxe(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Death_BAxe* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
