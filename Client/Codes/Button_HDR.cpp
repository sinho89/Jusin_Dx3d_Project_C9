...
CButton_HDR::CButton_HDR(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_HDR::~CButton_HDR(void)
{

}

HRESULT CButton_HDR::Ready_Object(void)
{
...
HRESULT CButton_HDR::Start_ForScene(void)
{
...
void CButton_HDR::Update_Object(const _float& fTimeDelta)
{
...
void CButton_HDR::Render_Object(void)
{
...
HRESULT CButton_HDR::Add_Component(void)
{
...
void CButton_HDR::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
	...
	if (m_bCollision)
	{
		if (Engine::Get_DIMouseState(Engine::CInput_Device::DIM_LB) & 0x80)
		{
			...
			if (m_bType)
			{
				CUI* pUI = ((CUI*)Engine::Find(L"System_HDR_Off_Button"));
				pUI->SetPick(false);
				::Safe_Release(pUI);
			}
			else
			{
				CUI* pUI = ((CUI*)Engine::Find(L"System_HDR_On_Button"));
				pUI->SetPick(false);
				::Safe_Release(pUI);
			}
			m_bPick = true;
...
void CButton_HDR::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_HDR* CButton_HDR::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_HDR*		pInstance = new CButton_HDR(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_HDR* CButton_HDR::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, _bool bType, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_HDR*		pInstance = new CButton_HDR(pGraphicDev, wstrName, eState, bIsActive);
