...
void CDunGeon_Select::Render_Object(void)
{
	...
	if(m_eType == DUNGEON_ICE)
		Engine::Render_Font(L"Font_Select_DunGeun", L"¿µÈ¥ÀÇ °è°î", &_vec2(m_fX - 30.f, m_fY - 15.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));
		// ¿µÈ¥ÀÇ°è°î
	else if (m_eType == DUNGEON_FIRE)
		Engine::Render_Font(L"Font_Select_DunGeun", L"È­»ê¼¶ ÁöÇÏÅë·Î", &_vec2(m_fX - 30.f, m_fY - 15.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));
		// È­»ê¼¶ ÁöÇÏÅë·Î
}
