...
class CUI_Dash : public CUI_Skill
{
protected:
	explicit CUI_Dash(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CUI_Dash(void);
...
public:
	static CUI_Dash* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CUI_Dash* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, 
