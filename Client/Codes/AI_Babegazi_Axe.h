...
protected:
	...
	enum BABEGAZI_AXE {
		...
		, DAM_UPPER_B, DAM_UPPER_C, DEFENCE_SWORD, DEFENCE, SPIN_A, SPIN_B, DOWN, STAND_UP, STUN, DISCOVERY
		,STAND_DOWN
		, ANI_END
	};
	enum AI_STATE {
...
protected:
	explicit CAI_Babegazi_Axe(void);
	virtual ~CAI_Babegazi_Axe(void);
