...
COption_J::COption_J(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
COption_J::~COption_J(void)
{

}

HRESULT COption_J::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 140.f;
	m_fY = (WINSIZEY >> 1);
...
HRESULT COption_J::Start_ForScene(void)
{
...
void COption_J::Update_Object(const _float& fTimeDelta)
{
...
void COption_J::Render_Object(void)
{
	...
	if(m_bClick || m_bCollision)
	{
		Engine::Render_Font(L"Font_Main_Data", L"(J) °­È­", &_vec2(m_fX - 30.f, m_fY - 45.f), D3DXCOLOR(1.f, 1.f, 1.f, m_fAlpha));
	}
}


HRESULT COption_J::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_J");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_J_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Option_J_Click");
...
void COption_J::Alpha_Calculation(const _float& fTimeDelta)
{
	if(!m_bRender)
	{
...
void COption_J::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
COption_J* COption_J::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	COption_J*		pInstance = new COption_J(pGraphicDev, wstrName, eState, bIsActive);
