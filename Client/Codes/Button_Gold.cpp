...
CButton_Gold::CButton_Gold(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_Gold::~CButton_Gold(void)
{

}

HRESULT CButton_Gold::Ready_Object(void)
{
...
HRESULT CButton_Gold::Start_ForScene(void)
{
...
void CButton_Gold::Update_Object(const _float& fTimeDelta)
{
...
void CButton_Gold::Render_Object(void)
{
	...
	Engine::Render_Font(L"Font_Main_Button", L"°ρµε Αυ°΅", &_vec2(m_fX - 25.f, m_fY - 10.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));

}


HRESULT CButton_Gold::Add_Component(void)
{
...
void CButton_Gold::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CButton_Gold::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_Gold* CButton_Gold::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Gold*		pInstance = new CButton_Gold(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_Gold* CButton_Gold::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Gold*		pInstance = new CButton_Gold(pGraphicDev, wstrName, eState, bIsActive);
