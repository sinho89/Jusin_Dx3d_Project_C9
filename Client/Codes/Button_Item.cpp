...
CButton_Item::CButton_Item(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_Item::~CButton_Item(void)
{

}

HRESULT CButton_Item::Ready_Object(void)
{
...
HRESULT CButton_Item::Start_ForScene(void)
{
...
void CButton_Item::Update_Object(const _float& fTimeDelta)
{
...
void CButton_Item::Render_Object(void)
{
	...
	Engine::Render_Font(L"Font_Main_Button", L"¾ÆÀÌÅÛ È¹µæ", &_vec2(m_fX - 35.f, m_fY - 10.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));

}


HRESULT CButton_Item::Add_Component(void)
{
...
void CButton_Item::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CButton_Item::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_Item* CButton_Item::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Item*		pInstance = new CButton_Item(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_Item* CButton_Item::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Item*		pInstance = new CButton_Item(pGraphicDev, wstrName, eState, bIsActive);
