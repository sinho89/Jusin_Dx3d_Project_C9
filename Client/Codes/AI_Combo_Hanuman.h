#ifndef AI_Combo_Hanuman_h__
#define AI_Combo_Hanuman_h__
...
class CAI_Combo_Hanuman
	: public CAI_Hanuman
{
private:
	explicit CAI_Combo_Hanuman(void);
	virtual ~CAI_Combo_Hanuman(void);
...
public:
	static CAI_Combo_Hanuman* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged,
		Engine::CAI* pAI, CSound* pSound);
