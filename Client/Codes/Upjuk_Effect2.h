#ifndef Upjuk_Effect2_h__
#define Upjuk_Effect2_h__
...
class CUI;
class CUpjuk_Effect2
	: public Engine::CEffect
{
private:
	explicit CUpjuk_Effect2(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName);
	virtual ~CUpjuk_Effect2(void);
...
public:
	static CUpjuk_Effect2* Create(LPDIRECT3DDEVICE9 pGraphicDev
