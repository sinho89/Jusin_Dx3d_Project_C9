...
CFPS_Check::CFPS_Check(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CFPS_Check::~CFPS_Check(void)
{

}

HRESULT CFPS_Check::Ready_Object(void)
{
...
HRESULT CFPS_Check::Start_ForScene(void)
{
...
void CFPS_Check::Update_Object(const _float& fTimeDelta)
{
...
void CFPS_Check::Render_Object(void)
{
...
HRESULT CFPS_Check::Add_Component(void)
{
...
void CFPS_Check::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CFPS_Check::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CFPS_Check* CFPS_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CFPS_Check*		pInstance = new CFPS_Check(pGraphicDev, wstrName, eState, bIsActive);
...
CFPS_Check* CFPS_Check::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CFPS_Check*		pInstance = new CFPS_Check(pGraphicDev, wstrName, eState, bIsActive);
