...
CButton_Exit::CButton_Exit(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_Exit::~CButton_Exit(void)
{

}

HRESULT CButton_Exit::Ready_Object(void)
{
	if (FAILED(Add_Component()))
		return E_FAIL;
		
	m_fX = m_pParent->GetInfo().x + 250.f;
	m_fY = m_pParent->GetInfo().y + 270.f;
...
HRESULT CButton_Exit::Start_ForScene(void)
{
...
void CButton_Exit::Update_Object(const _float& fTimeDelta)
{
...
void CButton_Exit::Render_Object(void)
{
	...
	Engine::Render_Font(L"Font_Main_Button", L"´Ý ±â", &_vec2(m_fX - 15.f, m_fY - 10.f), D3DXCOLOR(1.f, 1.f, 1.f, fFontAlpha));

}


HRESULT CButton_Exit::Add_Component(void)
{
...
void CButton_Exit::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
void CButton_Exit::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_Exit* CButton_Exit::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Exit*		pInstance = new CButton_Exit(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_Exit* CButton_Exit::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_Exit*		pInstance = new CButton_Exit(pGraphicDev, wstrName, eState, bIsActive);
