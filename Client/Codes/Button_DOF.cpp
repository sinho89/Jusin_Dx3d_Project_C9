...
CButton_DOF::CButton_DOF(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CButton_DOF::~CButton_DOF(void)
{

}

HRESULT CButton_DOF::Ready_Object(void)
{
...
HRESULT CButton_DOF::Start_ForScene(void)
{
...
void CButton_DOF::Update_Object(const _float& fTimeDelta)
{
...
void CButton_DOF::Render_Object(void)
{
...
HRESULT CButton_DOF::Add_Component(void)
{
...
void CButton_DOF::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
	...
	if (m_bCollision)
	{
		if (Engine::Get_DIMouseState(Engine::CInput_Device::DIM_LB) & 0x80)
		{
			...
			if (m_bType)
			{
				CUI* pUI = ((CUI*)Engine::Find(L"System_DOF_Off_Button"));
				pUI->SetPick(false);
				::Safe_Release(pUI);
			}
			else
			{
				CUI* pUI = ((CUI*)Engine::Find(L"System_DOF_On_Button"));
				pUI->SetPick(false);
				::Safe_Release(pUI);
			}
			m_bPick = true;
...
void CButton_DOF::SetParent(CUI* pParent)
{
	m_pParent = pParent;
}

CButton_DOF* CButton_DOF::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_DOF*		pInstance = new CButton_DOF(pGraphicDev, wstrName, eState, bIsActive);
...
CButton_DOF* CButton_DOF::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, CUI* pParent, _bool bType, Engine::CScene* pScene, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CButton_DOF*		pInstance = new CButton_DOF(pGraphicDev, wstrName, eState, bIsActive);
