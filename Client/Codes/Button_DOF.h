...
#ifndef Button_DOF_h__
#define Button_DOF_h__
...
class CButton_DOF : public CUI
{
private:
	explicit CButton_DOF(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CButton_DOF(void);
...
public:
	static CButton_DOF* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CButton_DOF* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
