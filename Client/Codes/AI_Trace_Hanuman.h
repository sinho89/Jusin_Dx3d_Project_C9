#ifndef AI_Trace_Hanuman_h__
#define AI_Trace_Hanuman_h__
...
class CAI_Trace_Hanuman
	: public CAI_Hanuman
{
private:
	explicit CAI_Trace_Hanuman(void);
	virtual ~CAI_Trace_Hanuman(void);
...
private:
	HRESULT Ready_State(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		...
		Engine::CAI* pAI);
public:
	static CAI_Trace_Hanuman* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, 
		Engine::CAI* pAI);
