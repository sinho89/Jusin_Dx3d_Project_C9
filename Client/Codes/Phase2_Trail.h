#ifndef Phase2_Trail_h__
#define Phase2_Trail_h__
...
{
private:
	explicit CPhase2_Trail(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName);
	virtual ~CPhase2_Trail(void);
...
public:
	static CPhase2_Trail* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring & wstrName);
