#ifndef AI_RoundPunch_Hanuman_h__
#define AI_RoundPunch_Hanuman_h__
...
class CAI_RoundPunch_Hanuman
	: public CAI_Hanuman
{
private:
	explicit CAI_RoundPunch_Hanuman(void);
	virtual ~CAI_RoundPunch_Hanuman(void);
...
public:
	static CAI_RoundPunch_Hanuman* Create(Engine::CTransform* pTransform, Engine::CAnimator* pAnimator,
		Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator,
		Engine::CRigidbody* pRigidbody, Engine::CCollider* pCollider,
		Engine::COLINFO* pColInfo, _bool* pDamaged, 
		Engine::CAI* pAI, CSound* pSound);
