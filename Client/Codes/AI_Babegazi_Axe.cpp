...
CAI_Babegazi_Axe::CAI_Babegazi_Axe(void)
	:Engine::CAI_State()
{
}
...
void CAI_Babegazi_Axe::Start_State(void)
{
}

void CAI_Babegazi_Axe::Update_State(const _float & fTimeDelta)
{
}

void CAI_Babegazi_Axe::End_State(void)
{
}

void CAI_Babegazi_Axe::Set_Ray(void)
{
...
void CAI_Babegazi_Axe::ChangeAni_Work(void)
{
...
void CAI_Babegazi_Axe::ChangeAI_Work(void)
{
	//AI 바뀌는곳..
...
void CAI_Babegazi_Axe::Free(void)
{

}

void CAI_Babegazi_Axe::CubeRayCheck(void)
{
