...
CMain_Pvp_Button::CMain_Pvp_Button(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
...
CMain_Pvp_Button::~CMain_Pvp_Button(void)
{

}

HRESULT CMain_Pvp_Button::Ready_Object(void)
{
	if(FAILED(Add_Component()))
		return E_FAIL;

	m_fX = (WINSIZEX >> 1) + 310.f;
...
HRESULT CMain_Pvp_Button::Start_ForScene(void)
{
...
void CMain_Pvp_Button::Update_Object(const _float& fTimeDelta)
{
...
void CMain_Pvp_Button::Render_Object(void)
{
...
HRESULT CMain_Pvp_Button::Add_Component(void)
{
	...
	m_pNCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_PVP_Button_NC");
	...
	m_pCTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_PVP_Button_C");
	...
	m_pClickTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGESTATIC, L"Main_PVP_Button_Click");
...
void CMain_Pvp_Button::PtInRect_Collision(const _float& fTimeDelta)
{
	POINT		ptMouse;
...
CMain_Pvp_Button* CMain_Pvp_Button::Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName, const Engine::OBJECTSTATE& eState /*= Engine::STATE_DEFAULT*/, const _bool bIsActive /*= true*/)
{
	CMain_Pvp_Button*		pInstance = new CMain_Pvp_Button(pGraphicDev, wstrName, eState, bIsActive);
...
void CMain_Pvp_Button::Free(void)
{
	CUI::Free();
}
