...
CAI_Discovery_KCommander::CAI_Discovery_KCommander(void)
	:CAI_Knole_Commander()
	, m_fAggroRad(0.f)
	, m_bAggro(false)
{
...
HRESULT CAI_Discovery_KCommander::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_Discovery_KCommander::Start_State(void)
{
	m_bAggro = false;
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

void CAI_Discovery_KCommander::Update_State(const _float & fTimeDelta)
{
...
void CAI_Discovery_KCommander::End_State(void)
{

}


void CAI_Discovery_KCommander::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_Discovery_KCommander * CAI_Discovery_KCommander::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged, _bool* pWeapon
	, Engine::CAI* pAI, CSound* pSound)
{
	CAI_Discovery_KCommander* pInstance = new CAI_Discovery_KCommander;
	...
	{
		MSG_BOX("CAI_Discovery_KCommander Created Failed");
...
void CAI_Discovery_KCommander::Free(void)
{
