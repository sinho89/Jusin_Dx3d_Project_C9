...
#ifndef Partition_Up_Button_h__
#define Partition_Up_Button_h__
...
class CPartition_Up_Button : public CUI
{
private:
	explicit CPartition_Up_Button(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CPartition_Up_Button(void);
...
public:
	static CPartition_Up_Button* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CPartition_Up_Button* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
