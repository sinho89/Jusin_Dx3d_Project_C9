...
CAI_Babegazi_Warrior::CAI_Babegazi_Warrior(void)
	:Engine::CAI_State()
{
}
...
void CAI_Babegazi_Warrior::Start_State(void)
{
}

void CAI_Babegazi_Warrior::Update_State(const _float & fTimeDelta)
{
}

void CAI_Babegazi_Warrior::End_State(void)
{
}

void CAI_Babegazi_Warrior::Set_Ray(void)
{
...
void CAI_Babegazi_Warrior::ChangeAni_Work(void)
{
...
void CAI_Babegazi_Warrior::ChangeAI_Work(void)
{
	//AI 바뀌는곳..
	...
	if (m_pAnimator->Get_AnimationIndex() == DAM_UPPER_C)
	{
		if (!m_bSpinB)
		{
			if (m_pCalculator->Get_IsCol())
...
void CAI_Babegazi_Warrior::Free(void)
{

}

void CAI_Babegazi_Warrior::CubeRayCheck(void)
{
