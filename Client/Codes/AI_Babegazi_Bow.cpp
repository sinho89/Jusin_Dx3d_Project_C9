...
CAI_Babegazi_Bow::CAI_Babegazi_Bow(void)
	:Engine::CAI_State()
{
}
...
void CAI_Babegazi_Bow::Start_State(void)
{
}

void CAI_Babegazi_Bow::Update_State(const _float & fTimeDelta)
{
}

void CAI_Babegazi_Bow::End_State(void)
{
}

void CAI_Babegazi_Bow::Set_Ray(void)
{
...
void CAI_Babegazi_Bow::ChangeAni_Work(void)
{
...
void CAI_Babegazi_Bow::ChangeAI_Work(void)
{
	//AI 바뀌는곳..
...
void CAI_Babegazi_Bow::Free(void)
{

}

void CAI_Babegazi_Bow::CubeRayCheck(void)
{
