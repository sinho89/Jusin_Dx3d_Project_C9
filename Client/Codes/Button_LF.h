...
#ifndef Button_LF_h__
#define Button_LF_h__
...
class CButton_LF : public CUI
{
private:
	explicit CButton_LF(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	virtual ~CButton_LF(void);
...
public:
	static CButton_LF* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
		const Engine::OBJECTSTATE& eState = Engine::STATE_DEFAULT, const _bool bIsActive = true);
	static CButton_LF* Create(LPDIRECT3DDEVICE9 pGraphicDev, const wstring& wstrName,
