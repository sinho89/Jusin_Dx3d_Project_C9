...
CAI_WhirlWind2_Bardiel::CAI_WhirlWind2_Bardiel(void)
	:CAI_Bardiel()
	,m_bAttackCol1(false)
	,m_bAttackCol2(false)
	,m_bAttackCol3(false)
...
HRESULT CAI_WhirlWind2_Bardiel::Ready_State(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
...
void CAI_WhirlWind2_Bardiel::Start_State(void)
{
...
void CAI_WhirlWind2_Bardiel::Update_State(const _float & fTimeDelta)
{
	...
	if (m_pAnimator->Get_AnimationIndex() == ATT_WHIRLWIND)
	{
		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.0,
			(*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.1))
		{
			m_pSound->MyPlaySound(L"Bardiel_WhirlWind_Voice");
		}

		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.3,
			(*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.5))
		{
			m_pSound->MyPlaySound(L"Bardiel_Swing_3");
		}

		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.5,
			(*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.6))
		{
			m_pSound->MyPlaySound(L"Bardiel_WhirlWind_Swing");
		}

		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.8,
			(*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.85))
		{
			m_pSound->MyPlaySound(L"Bardiel_Swing_4");
		}

		if (m_pAnimator->IsPlaying_ThisSection((*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.2,
			(*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dStartTime + (*m_pvecAniInfo)[ATT_WHIRLWIND]->tMotionInfo.dEndTime * 0.65))
		{
			if (!m_bAttackCol1)
			{
				m_bAttackCol1 = true;
				m_pSphereCollider->SetScale(50.f);
...
void CAI_WhirlWind2_Bardiel::End_State(void)
{
	ZeroMemory(m_bCol, sizeof(bool) * Engine::COL_INFO_END);
}

//void CAI_WhirlWind2_Bardiel::CubeRayCheck(void)
//{
...
void CAI_WhirlWind2_Bardiel::Collsion_Work(void)
{
	if (*m_pDamaged)
	{
...
CAI_WhirlWind2_Bardiel * CAI_WhirlWind2_Bardiel::Create(Engine::CTransform * pTransform, Engine::CAnimator * pAnimator,
	Engine::CNavigationMesh* pNaviMesh, Engine::CCalculator* pCalculator, Engine::CRigidbody* pRigidbody
	, Engine::CCollider* pCollider, Engine::COLINFO* pColInfo, _bool* pDamaged
	, Engine::CAI* pAI, CSound* pSound)
{
	CAI_WhirlWind2_Bardiel* pInstance = new CAI_WhirlWind2_Bardiel;
	...
	{
		MSG_BOX("CAI_WhirlWind2_Bardiel Created Failed");
...
void CAI_WhirlWind2_Bardiel::Free(void)
{
